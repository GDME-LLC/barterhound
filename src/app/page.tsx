...
export default function HomePage() {
  return (
    <main className="space-y-10">
      <section className="rounded-[2rem] bg-gradient-to-br from-brand-600 via-brand-500 to-amber-400 px-8 py-16 text-white shadow-lg">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/signup" className="rounded-full bg-white px-5 py-3 font-medium text-brand-700 transition hover:bg-brand-50">
            Create account
          </Link>
          <Link href="/listings" className="rounded-full border border-white/40 px-5 py-3 font-medium text-white transition hover:bg-white/10">
            Browse listings
          </Link>
        </div>
      </section>
